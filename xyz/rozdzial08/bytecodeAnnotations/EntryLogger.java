...
/**
 * Dodaje kod zapisu komunikatów dziennika do wszystkich metod 
 * oznaczonych adnotacją LogEntry.
...
public class EntryLogger extends ClassVisitor
{
   ...
   public static void main(String[] args) throws IOException
   {
      if (args.length == 0)
      {
         System.out.println("Sposób użycia: java bytecodeAnnotations.EntryLogger classfile");
         System.exit(1);
      }
