...
public class SplashScreenTest
{
   ...
   private static void init1()
   {
      ...
      if (splash == null)
      {
         System.err.print("Czy obrazek ekranu powitalnego został określony ");
         System.err.println("przy użyciu -splash lub w pliku manifestu?");
         System.exit(1);
      }
   ...
   /**
    * Metoda wyświetlająca ramkę o tej samej zawartości co ekran powitalny.
    */
   private static void init2()
   {
      ...
      new SwingWorker<Void, Integer>()
      {
         ...
         protected void process(List<Integer> chunks)
         {
            ...
            {
               progressBar.setString("Wczytywanie modułu " + chunk);
