...
/**
 * Ramka zawierająca listę rozwijalną wyboru figury oraz panel, na którym 
 * rysowana jest jej reprezentacja.
 */
...
/**
 * Komponent rysujący figurę i umożliwiający przesuwanie definiujących 
 * ją punktów.
 */
...
/**
 * Klasa abstrakcyjna reprezentująca figurę za pomocą zbioru punktów 
 * kontrolnych. Jej konkretne klasy pochodne muszą implementować
...
/**
 * Tworzy elipsę zawartą w prostokącie ograniczającym rozpiętym za pomocą 
 * dwu narożników.
 */
...
/**
 * Tworzy łuk zawarty w prostokącie ograniczającym rozpiętym za pomocą 
 * dwu narożników. Dodatkowe dwa punkty kontrolne umożliwiają określenie 
 * wartości początkowej i końcowej kąta łuku. Aby zilustrować poprawność 
 * obliczeń kątów łuku, metoda makeShape zwraca figurę złożoną z łuku, 
 * prostokąta ograniczającego i linii łączących środek łuku z punktami 
 * kontrolnymi kąta.
 */
