...
public class ImageProcessingFrame extends JFrame
{
   ...
   public ImageProcessingFrame()
   {
      ...
      JMenuItem blurItem = new JMenuItem("Zamazanie");
      ...
      JMenuItem sharpenItem = new JMenuItem("Wyostrzenie");
      ...
      JMenuItem brightenItem = new JMenuItem("Rozjaśnienie");
      ...
      JMenuItem edgeDetectItem = new JMenuItem("Wykrywanie krawędzi");
      ...
      JMenuItem rotateItem = new JMenuItem("Obrót");
   ...
   public void openFile()
   {
      ...
      chooser.setFileFilter(new FileNameExtensionFilter("Pliki obrazów", extensions));
