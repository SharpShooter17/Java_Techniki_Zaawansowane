...
public class PlanetTableFrame extends JFrame
{
   ...
   public PlanetTableFrame()
   {
      ...
      JMenu selectionMenu = new JMenu("Wybór");
      ...
      JMenuItem hideRowsItem = new JMenuItem("Ukryj wiersze");
      ...
      JMenuItem showRowsItem = new JMenuItem("Pokaż wiersze");
      ...
      JMenuItem printSelectionItem = new JMenuItem("Drukuj zaznaczenie");
