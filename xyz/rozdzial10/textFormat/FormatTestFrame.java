...
public class FormatTestFrame extends JFrame
{
   ...
   public FormatTestFrame()
   {
      ...
      addRow("Liczba (z zatwierdzaniem):", intField2);
      ...
      addRow("Liczba filtrowana", intField3);
      ...
      addRow("Liczba sprawdzana:", intField4);
      ...
      addRow("Data (krótka, format ścisły):", dateField2);
